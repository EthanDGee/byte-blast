...
game_over_screen = Sprite(40, 40, GAME_OVER_BIT_MAP, 0, 0)
title_screen = Sprite(70, 30, TITLE_BIT_MAP, 1, 0)
...
while not game_started:
    ...
    display.drawLine(0, 0, 0, 30, 1)
    display.drawLine(71, 0, 71, 30, 1)
    display.drawLine(0, 30, 72, 30, 1)

    display.drawText("Start: A | Exit: B", 0, 33, 1)
